...
//        self.skipBtn.isHidden = true
    ...
    private func createSlides() -> [IntroItem] {
        ...
        slide1.firstLabel.text = (NSLocalizedString("User friendly mp3 music player for your device", comment: ""))
...
//        slide2.firstLabel.text = (NSLocalizedString("We provide a better audio experience than others", comment: ""))
        ...
        slide3.firstLabel.text = NSLocalizedString("Listen to the best audio & music with deepsound now!", comment: "")
